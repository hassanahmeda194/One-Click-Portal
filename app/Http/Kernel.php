...
use App\Http\Middleware\Custom\Authorized;
use App\Http\Middleware\Custom\CheckPermissions;
use App\Http\Middleware\Custom\CheckRole;
use App\Http\Middleware\Custom\EncryptRouteVariables;
