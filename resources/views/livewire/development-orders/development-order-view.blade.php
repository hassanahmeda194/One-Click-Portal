...
<div class="page-header d-xl-flex d-block">
    <div class="page-rightheader ms-md-auto">
        <div class="d-flex align-items-end flex-wrap my-auto end-content breadcrumb-end">
            <div class="btn-list">
                @if ((int) $auth_user->Role_ID != 3 || $auth_user->EMP_ID == 'REG-60')
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item"
                                href="{{ route('Development.Order.edit', ['Order_ID' => $DevelopmentOrder->Order_ID]) }}">Edit
                                Order</a>
                            <a class="dropdown-item" href="javascript:void(0);"
                                onclick="confirmCancelOrder('{{ route('cancle.development.order', ['Order_ID' => $DevelopmentOrder->id]) }}')">
                                Cancel Order
                            </a>
                            <a class="dropdown-item"
                                href="{{ route('delete.development.order', ['Order_ID' => $DevelopmentOrder->id]) }}">Delete
                               Order</a>
                            @endif
                        </div>
                    </div>
    ...
    <div class="col-xl-9 col-md-12 col-lg-12">
        ...
        <div class="panel-body tabs-menu-body hremp-tabs1 p-0">
            <div class="tab-content">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table text-center table-vcenter text-nowrap table-bordered border-bottom"
                                ...
                                <tbody>
                                    @forelse ($DevelopmentOrder->attachments as $attachment)
                                        <tr>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table text-center table-vcenter text-nowrap table-bordered border-bottom"
                                ...
                                <tbody>
                                    @forelse($DevelopmentOrder->final_submission as $submission)
                                        <tr>
                                            <td class="text-center">{{ $loop->iteration }}</td>
                                            <td>
                ...
                @if (!empty($DevelopmentOrder->revision))
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table text-center table-vcenter text-nowrap table-bordered border-bottom"
                                    ...
                                    <tbody>
                                        @foreach ($DevelopmentOrder->revision as $revision)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                @if(in_array(Auth::guard('Authorized')->user()->Role_ID , [1,9,10,11]))
                            ...
                            <table class="table text-center table-vcenter text-nowrap table-bordered border-bottom"
                                ...
                                <tbody>
                                    @php
                                        $c = 1;
                                    @endphp
                                    @foreach ($DevelopmentOrder->draftSubmissions as $submission)
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold">{{ $DevelopmentOrder->Order_ID }}</span>
                                </td>
                            </tr>
                            
                            @if ($auth_user->Role_ID == 3)
                                @foreach ($DevelopmentOrder->assign_dead_lines as $assign_dead_line)
                                ...
                                @endforeach
                            @else
                                @if (!empty($DevelopmentOrder->development_info->project_service))
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span
                                                class="font-weight-semibold">{{ $DevelopmentOrder->development_info->project_service == 1 ? 'Wordpress' : 'Custom' }}</span>
                                        </td>
                                    </tr>
                                @endif
                                ...
                                @if (!empty($DevelopmentOrder->submission_info->DeadLine))
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="font-weight-semibold text-danger">{{ $DevelopmentOrder->submission_info->DeadLine }}</span>
                                        </td>
                                    </tr>
                                @endif
                                @if (!empty($DevelopmentOrder->submission_info->DeadLine_Time))
                                    <tr>
                                        <td>
                                            <span class="w-50">DeadLine Time</span>
                                        </td>
                                        ...
                                        <td>
                                            <span
                                                class="font-weight-semibold text-danger">{{ $DevelopmentOrder->submission_info->DeadLine_Time }}</span>
                                        </td>
                                    </tr>
                                @endif
                            @endif
                          ...
                          @if (!empty($DevelopmentOrder->development_info) && isset($DevelopmentOrder->development_info->order_status))
                            @php
                                $status = 'Unknown'; // Default status if none of the conditions match
                                switch ($DevelopmentOrder->development_info->order_status) {
                                    case 0:
                                        $status = 'Working';
                                        break;
                                    case 1:
                        ...
                        @endif
                            ...
                            @if($auth_user->Role_ID != 3)
                             @if (!empty($DevelopmentOrder->development_info->website_order))
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <span
                                            class="font-weight-semibold">{{ $DevelopmentOrder->development_info->website_order }}</span>
                                    </td>
                                </tr>
                            @endif
                            @endif
                            @if (!empty($DevelopmentOrder->created_at))
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <span
                                            class="font-weight-semibold">{{ $DevelopmentOrder->created_at->format('Y-m-d') }}</span>
                                    </td>
                                </tr>
                            @endif
                            @if (!empty($DevelopmentOrder->created_at))
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="font-weight-semibold">{{ $DevelopmentOrder->created_at->format('H:i:s') }}</span>
                                    </td>
                                </tr>
                            @endif
                        </tbody>
            ...
            <div class="card">
                ...
                <div class="card-body pt-2 ps-3 pr-3">
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                @if ($DevelopmentOrder->authorized_user->basic_info)
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span
                                                class="font-weight-semibold">{{ $DevelopmentOrder->authorized_user->basic_info->F_Name . ' ' . $DevelopmentOrder->authorized_user->basic_info->L_Name }}</span>
                                        </td>
                                    </tr>
                                @endif
            ...
            <div class="card">
                ...
                <div class="card-body pt-2 ps-3 pr-3">
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                @if (!empty($DevelopmentOrder->client_info->Client_Name))
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span
                                                class="font-weight-semibold">{{ $DevelopmentOrder->client_info->Client_Name }}</span>
                                        </td>
                                    </tr>
                                @endif
                                @if (!empty($DevelopmentOrder->client_info->Client_Country))
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="font-weight-semibold">{{ $DevelopmentOrder->client_info->Client_Country }}</span>
                                        </td>
                                    </tr>
                                @endif
                                @if (!empty($DevelopmentOrder->client_info->Client_Phone))
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span
                                                class="font-weight-semibold">{{ $DevelopmentOrder->client_info->Client_Phone }}</span>
                                        </td>
                                    </tr>
                                @endif
                                @if (!empty($DevelopmentOrder->client_info->Client_Email))
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span
                                                class="font-weight-semibold">{{ $DevelopmentOrder->client_info->Client_Email }}</span>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
            ...
            <div class="card">
                ...
                <div class="card-body pt-2 ps-3 pr-3">
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                @foreach ($DevelopmentOrder->assign as $user)
                                    <tr>
                                        <td>
            ...
            <div class="card">
                ...
                <div class="card-body pt-2 ps-3 pr-3">
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                @if (!empty($DevelopmentOrder->payment_info->Order_Price))
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span class="font-weight-semibold">
                                                &nbsp; {{ $DevelopmentOrder->payment_info->Order_Price }}</span>
                                        </td>
                                    </tr>
                                @endif
                                @if (!empty($DevelopmentOrder->payment_info->Order_Price))
                                    <tr>
                                        ...
                                        <td>
                                            <span class="font-weight-semibold">
                                                {{ $DevelopmentOrder->payment_info->Payment_Status }}
                                            </span>
                                        </td>
                                    </tr>
                                @endif
                                @if (!empty($DevelopmentOrder->payment_info->Rec_Amount))
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span class="font-weight-semibold">
                                                {{ $DevelopmentOrder->payment_info->Rec_Amount }}
                                            </span>
                                        </td>
                                    </tr>
                                @endif
                                @if (!empty($DevelopmentOrder->payment_info->Due_Amount))
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span class="font-weight-semibold">
                                                {{ $DevelopmentOrder->payment_info->Due_Amount }}</span>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
            ...
            <form action="" method="POST" class="needs-validation was-validated"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="table-responsive mt-5">
                            <h4 class="my-4">Upload by Developer</h4>
                            <table class="table text-center table-vcenter text-nowrap table-bordered border-bottom"
...
<div class="modal fade" id="SubmitRevision">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('Submit.Upload.Order.Revision.Development') }}" method="POST"
                class="needs-validation was-validated" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
...
@include('partials.development-order-custom-script');
